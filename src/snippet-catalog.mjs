...
const fallbackSnippets = [
  ...
  defineSnippet({
    ...
    variant: "Dark",
    prefixes: ["!d-dark"],
    description: "Dark-themed HTML document starter with DaisyUI and Tailwind browser CDN links.",
    body: String.raw`
      <!doctype html>
      <html lang="en" data-theme="\${1:dark}">
      <head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>\${2:DaisyUI Dark Starter}</title>
        <link href="https://cdn.jsdelivr.net/npm/daisyui@5" rel="stylesheet" type="text/css" />
        <script src="https://cdn.jsdelivr.net/npm/@tailwindcss/browser@4"></script>
      </head>
      <body class="min-h-screen bg-base-300">
        <main class="mx-auto flex min-h-screen max-w-6xl items-center px-6 py-16">
          <section class="hero w-full rounded-box border border-base-content/10 bg-base-200 shadow-2xl">
            <div class="hero-content text-center">
              <div class="max-w-2xl">
                <span class="badge badge-secondary mb-4">\${3:Dark-mode ready}</span>
                <h1 class="text-4xl font-bold text-balance md:text-5xl">\${4:Ship a sharper dark UI fast}</h1>
                <p class="py-6 text-base-content/70">\${5:Use DaisyUI components and Tailwind utilities to prototype a moody, polished interface in one HTML file.}</p>
                <div class="flex flex-col justify-center gap-3 sm:flex-row">
                  <button type="button" class="btn btn-primary">\${6:Launch project}</button>
                  <button type="button" class="btn btn-ghost">\${7:View patterns}</button>
                </div>
              </div>
            </div>
          </section>
  ...
  defineSnippet({
    component: "Document",
    variant: "Corporate",
    prefixes: ["!d-corporate"],
    description: "Corporate-themed HTML document starter with DaisyUI and Tailwind browser CDN links.",
    body: String.raw`
      <!doctype html>
      <html lang="en" data-theme="\${1:corporate}">
      <head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>\${2:DaisyUI Corporate Starter}</title>
        <link href="https://cdn.jsdelivr.net/npm/daisyui@5" rel="stylesheet" type="text/css" />
        <script src="https://cdn.jsdelivr.net/npm/@tailwindcss/browser@4"></script>
      </head>
      <body class="min-h-screen bg-base-200">
        <main class="mx-auto flex min-h-screen max-w-6xl items-center px-6 py-16">
          <section class="hero w-full rounded-box bg-base-100 shadow-xl">
            <div class="hero-content text-center">
              <div class="max-w-2xl">
                <span class="badge badge-accent badge-outline mb-4">\${3:Presentation-ready}</span>
                <h1 class="text-4xl font-bold text-balance md:text-5xl">\${4:Build a confident product surface}</h1>
                <p class="py-6 text-base-content/80">\${5:Start with a crisp, structured DaisyUI layout tailored for product demos, docs, and internal tools.}</p>
                <div class="flex flex-col justify-center gap-3 sm:flex-row">
                  <button type="button" class="btn btn-primary">\${6:See workflow}</button>
                  <button type="button" class="btn btn-outline">\${7:Open guide}</button>
                </div>
              </div>
            </div>
          </section>
